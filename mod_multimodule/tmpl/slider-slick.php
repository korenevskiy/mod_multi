...
echo "<div class=\"slider items slick  count$count $moduleclass_sfx \"  itemscope itemtype=\"http://schema.org/ImageGallery\">";// id$id pos$positon 
...
//    JHtml::script("//cdn.jsdelivr.net/npm/slick-carousel@1.9.0/slick/slick.min.js");
//    JHtml::stylesheet("//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css");
//    JHtml::script("//raw.githubusercontent.com/kenwheeler/slick/master/slick/slick.min.js");
//    JHtml::stylesheet("//raw.githubusercontent.com/kenwheeler/slick/master/slick/slick.css");
    
//    JHtml::script("//ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js");
//    JHtml::script("//cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.js");
//    JHtml::stylesheet("//cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.css");
...
//    JHtml::stylesheet($mod_path."slick-1.9.0/slick-theme.css"); 
    
    
    //JHtml::stylesheet("//cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick-theme.css");
...
$id      = $params->get('id');
$json_slick      = $params->get('json_slick');
