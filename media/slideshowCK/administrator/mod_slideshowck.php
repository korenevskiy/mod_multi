...
if (! defined('SLIDESHOWCK_PATH'))
    define('SLIDESHOWCK_PATH', JPATH_ROOT . '/administrator/components/com_slideshowck');
...
if (empty($items) || $items === false) {
    if ($params->get('debug', true) === true)
        echo '<p>SLIDESHOW CK : No items found.</p>';
    return;
}
...
$js = "
		jQuery(document).ready(function(){
			new Slideshowck('#camera_wrap_" . $module->id . "', {
				...
				fx: '" . implode(",", $params->get('effect', array(
    'linear'
))) . "',
...
if ($params->get('fixhtml', '0') == '1')
    include_once SLIDESHOWCK_PATH . '/helpers/htmlfixer.php';
