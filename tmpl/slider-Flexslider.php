...
//        toPrint($params->get('title_tag',''),'title_tag');
...
echo "<div id='multislideshowid$current_id' class='flexslider'> ";
echo "<ul     class=' slides flexslider$param->id card-carousel -gallery items count$count $moduleclass_sfx  id$param->id Feature-Carousel'   
...
//    if($tag_container)
		echo "<li class='carousel-feature my-card'>";
	if($param->items_link) 
		echo "<a class=' '   rel='group' href='/' title='$module->title'  >";
	echo "<img class='$module->moduleclass_sfx thumb' src='$base/$module->image' alt='$module->title' title='$module->title'  oncontextmenu='return false;'
	xstyle=' max-width: 220px; max-height: 320px'>";
...
//if($module->content) echo  "<span class='info'>$module->content</span>"; $module->link
	...
	if($param->items_link && $param->items_link != 'a')
...
$wa	->registerAndUseScript('jquery.mousewheel', 'modules/mod_multi/media/FlexSlider/demo/js/jquery.mousewheel.js', 
		['version' => 'auto'], ['defer' => false], ['jquery','jquery.ui']) //'defer' => false
		
	->registerAndUseScript('modernizr', 'modules/mod_multi/media/FlexSlider/demo/js/modernizr.js', 
		['version' => 'auto'], [], ['jquery','jquery.ui' ,'jquery.mousewheel'])
		
	->registerAndUseScript('jquery.easing', 'modules/mod_multi/media/FlexSlider/demo/js/jquery.easing.js', 
		['version' => 'auto'], [], ['jquery','jquery.ui' ,'jquery.mousewheel','modernizr'])
		
	->registerAndUseScript('jquery.flexslider', 'modules/mod_multi/media/FlexSlider/jquery.flexslider.js', 
		['version' => 'auto'], [], ['jquery','jquery.ui' ,'jquery.mousewheel','modernizr','jquery.easing']);
		  
//JHtml::script(	  "modules/mod_multi/media/FlexSlider/demo/js/jquery.mousewheel.js"); 
//JHtml::script(	  "modules/mod_multi/media/FlexSlider/demo/js/modernizr.js"); 
//JHtml::script(	  "modules/mod_multi/media/FlexSlider/demo/js/jquery.easing.js"); 
//JHtml::script(	  "modules/mod_multi/media/FlexSlider/demo/js/jquery.flexslider.js"); 
JHtml::stylesheet("modules/mod_multi/media/FlexSlider/flexslider.css");
...
$script = <<< script
/* MultiModule ModuleID:{$current_id} $style_layout   .flexslider{$current_id}*/
jQuery('#multislideshowid$current_id').ready(function($){
  $('#multislideshowid$current_id').flexslider({
$json_layout
  });
});
script;
