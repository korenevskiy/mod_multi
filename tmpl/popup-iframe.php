...
$img = "";
if ($image_show && $image)
    $img = "<img class=\"multiimage\" src=\"$image\" alt=\"$title\" title=\"$title\"  />";
...
if ($modules_tag == 'div div' && $mod_show)
    echo "<div class='modalWindow" . $module->id . " modalWindow modal modal-sm fade moduleModal$moduleClassSfx'  tabindex='-1'>" . "<div class='modal-dialog'><div class='modal-content'>";
