...
//    $path = JUri::base() . 'modules/mod_multi/media/Slicebox/';
//$script = "/modules/mod_multi/media/jqfancytransitions/jquery.slicebox.js"; 
...
//    JHtml::script('/modules/mod_multi/media/Slicebox/js/jquery.slicebox.js');
...
//    JHtml::stylesheet(JUri::base() . 'modules/mod_multi/media/Slicebox/css/custom.css');
    //JHtml::stylesheet($path.'css/demo.css');
//    JHtml::stylesheet($path.'slick-theme.css'); 
//    modules/mod_multi/media/box-slider/js/lib/modernizr.min.js
//    toPrint($path,'$path');
