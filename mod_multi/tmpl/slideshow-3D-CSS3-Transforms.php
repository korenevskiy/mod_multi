...
if($params->get('items_image') && $module->image):
    if($params->get('items_image') == 'ai')
        echo $prepare("<a class=\"$class image\"  target=\"_blank\" href=\"$module->link\"  title=\"$module->title\"
            ...
            <img class=\" item_image $module->moduleclass_sfx\" src=\"$module->image\"></a>");   
    ...
    if($params->get('items_image') == 'di') 
        echo $prepare("<div class='$class image'><img  class=\"   item_image  $module->moduleclass_sfx\"  data-action=\"zoom\"  src=\"$module->image\"></div>");       
